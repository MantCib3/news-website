...
const WorldSection = ({ articles, navigate }) => {
    return (
        <section id="world" className="flex-1 max-w-md">
            <h2 className="text-xl font-serif font-bold mb-4 flex items-center">
                World
                <i className="fa fa-arrow-right ml-2 text-sm cursor-pointer" onClick={() => navigate('section', { sectionId: 'world' })}></i>
            </h2>
