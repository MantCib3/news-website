...
const SearchView = ({ articlesData, navigate, searchParams, setSearchParams }) => {
    ...
    return (
        <div className="w-full max-w-4xl">
            ...
            <h1 className="text-3xl font-serif font-bold mb-6 text-center">Search</h1>
            ...
            <div className="flex flex-col gap-4">
                ...
                )) : <div className="text-sm font-sans text-gray-700 text-center py-4">Enter search filters to view results.</div>}
            </div>
        </div>
    );
};
